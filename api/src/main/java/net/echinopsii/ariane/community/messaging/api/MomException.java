 ...
 * Mom Exception
 *
 * Copyright (C) 2/08/16 echinopsii
 *
...
public class MomException extends Exception {
    ...
    public MomException(String message, Throwable cause) {
        super(message,cause);
    }

    public MomException(Throwable cause) {
        super(cause);
    }

    protected MomException(String message, Throwable cause,
